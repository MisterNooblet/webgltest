...
for (var XX = 0; XX <= splitremoveID.length - 1; XX++ ){
    //variables to hold the index of currently checked letter.
    var splitindex1 = letters.indexOf(splitremoveID[XX]);
    var splitindex2 = solution.indexOf(splitremoveID[XX]);
    ...
    if(splitindex1>-1 && splitindex2 >-1){
        ...
        guessed.indexOf(splitremoveID[XX]) === -1 ? guessed.push(splitremoveID[XX]) : null;
        guessedWord();
        checkIfGameWon();
